...
type repositoryScyllaX struct {
	ses gocqlx.Session
	st  *table.Table
}

func (r repositoryScyllaX) GetRecord(ctx context.Context, id uuid.UUID) (models.Record, error) {
...
func (r repositoryScyllaX) SetRecord(ctx context.Context, record models.Record) (models.Record, error) {
	recordS := scyllat.RecordsStruct{
		Id:     record.ID,
		Record: record.Data,
	}
...
func (r repositoryScyllaX) insert(ctx context.Context, recordS scyllat.RecordsStruct) (models.Record, error) {
	recordS.Id = uuid.New()
...
func (r repositoryScyllaX) update(ctx context.Context, recordS scyllat.RecordsStruct) (models.Record, error) {
...
func (r repositoryScyllaX) DeleteRecord(ctx context.Context, id uuid.UUID) (models.Record, error) {
...
func NewScyllaXRepository(ctx context.Context, addr string) (Repository, error) {
	...
	return repositoryScyllaX{ses: session, st: scyllat.Records}, nil
}
